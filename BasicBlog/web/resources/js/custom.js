...
function commentValidation() {
    ...
    /*
    if(document.getElementById["commentform:name"].value == ""){
        alert("Semua isian form harus diisi");
        return false;
    }
    */
    ...
    if (!emailValidation(document.getElementById('commentform:email').value)) {
        return false;
    }
    
    //document.getElementById["commentform:email"].value = "";
    //document.getElementById["commentform:name"].value == "";
    //document.getElementById["commentform:content"].value == "";
